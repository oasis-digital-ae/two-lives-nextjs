...
export function ArrowUpDownIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path d="M7 3v18M7 3 3 7M7 3l4 4M17 21V3M17 21l-4-4M17 21l4-4" />
    </svg>
  );
}
...
export function HourglassIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path d="M6 2h12M6 22h12M6 2c0 6 5 6 6 10 1-4 6-4 6-10M6 22c0-6 5-6 6-10 1 4 6 4 6 10" />
    </svg>
  );
}
...
export function ActivityIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path d="M2 12h4l2 8 4-16 2 8h4" strokeLinejoin="round" />
    </svg>
  );
}
...
export function SlidersIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path d="M4 6h9M17 6h3M4 12h3M11 12h9M4 18h13M21 18h-.01" />
...
export function TreeIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className={className}>
      <path d="M12 22v-7" />
      <path d="M12 15 6 9h3L5 4h14l-4 5h3l-6 6Z" strokeLinejoin="round" />
    </svg>
  );
}
